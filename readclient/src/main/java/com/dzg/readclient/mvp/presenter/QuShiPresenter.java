...
public class QuShiPresenter implements QuShiContract.Presenter{
    private GetQuShi mUsecase;
    private QuShiContract.View mView;
    private CompositeSubscription mCompositeSubscription;
    @Override
    public void attachView(QuShiContract.View view) {
        mView=view;
    ...
    public QuShiPresenter(GetQuShi Usecase) {
    ...
    public void refreshAll( int newOrHotFlag, int count) {
        Subscription subscribe =mUsecase.execute(new GetQuShi.RequestValues(newOrHotFlag,1,0,count)).getList()
   ...
   @Override
    ...
    Subscription subscription=mUsecase.execute(new GetQuShi.RequestValues(newOrHotFlag,1,offset,count))
              .getList()
               .subscribeOn(Schedulers.io())
               .observeOn(AndroidSchedulers.mainThread())
               .subscribe(new Observer<ResponseInfo>() {
