package com.dzg.readclient.ui.view;
...
import com.dzg.readclient.commons.RcpUri;
...
import com.dzg.readclient.utils.ImgToastUtils;
...
//		api = WXAPIFactory.createWXAPI(context, com.lling.qiqu.wxapi.Constants.APP_ID);
    ...
    public void showAtLocation(View parent, int gravity, int x, int y) {
    	if(ReadClientApp.getInstance().currentUser != null) {
			userId = ReadClientApp.getInstance().currentUser.getId();
    	}
	...
	*//**
	...
	private void share2QQFriends() {
	    ...
	    ReadClientApp.getInstance().mTencent.shareToQQ((Activity)context, params, iUiListener);
	}
	...
	*//**
	...
	private void share2QZone() {
		...
		ReadClientApp.getInstance().mTencent.shareToQzone((Activity)context, params, iUiListener);
	}
